...
/// call it upon all exit conditions. 
 pub fn SDL_Quit ( ) ; } extern "C" { pub fn TTF_Linked_Version ( ) -> * const SDL_version ; } extern "C" { pub fn TTF_ByteSwappedUNICODE ( swapped : ctypes :: c_int ) ; } # [ repr ( C ) ] # [ derive ( Debug , Copy , Clone ) ] pub struct _TTF_Font { _unused : [ u8 ; 0 ] , } pub type TTF_Font = _TTF_Font ; extern "C" { pub fn TTF_Init ( ) -> ctypes :: c_int ; } extern "C" { pub fn TTF_OpenFont ( file : * const ctypes :: c_char , ptsize : ctypes :: c_int ) -> * mut TTF_Font ; } extern "C" { pub fn TTF_OpenFontIndex ( file : * const ctypes :: c_char , ptsize : ctypes :: c_int , index : ctypes :: c_long ) -> * mut TTF_Font ; } extern "C" { pub fn TTF_OpenFontRW ( src : * mut SDL_RWops , freesrc : ctypes :: c_int , ptsize : ctypes :: c_int ) -> * mut TTF_Font ; } extern "C" { pub fn TTF_OpenFontIndexRW ( src : * mut SDL_RWops , freesrc : ctypes :: c_int , ptsize : ctypes :: c_int , index : ctypes :: c_long ) -> * mut TTF_Font ; } extern "C" { pub fn TTF_GetFontStyle ( font : * const TTF_Font ) -> ctypes :: c_int ; } extern "C" { pub fn TTF_SetFontStyle ( font : * mut TTF_Font , style : ctypes :: c_int ) ; } extern "C" { pub fn TTF_GetFontOutline ( font : * const TTF_Font ) -> ctypes :: c_int ; } extern "C" { pub fn TTF_SetFontOutline ( font : * mut TTF_Font , outline : ctypes :: c_int ) ; } extern "C" { pub fn TTF_GetFontHinting ( font : * const TTF_Font ) -> ctypes :: c_int ; } extern "C" { pub fn TTF_SetFontHinting ( font : * mut TTF_Font , hinting : ctypes :: c_int ) ; } extern "C" { pub fn TTF_FontHeight ( font : * const TTF_Font ) -> ctypes :: c_int ; } extern "C" { pub fn TTF_FontAscent ( font : * const TTF_Font ) -> ctypes :: c_int ; } extern "C" { pub fn TTF_FontDescent ( font : * const TTF_Font ) -> ctypes :: c_int ; } extern "C" { pub fn TTF_FontLineSkip ( font : * const TTF_Font ) -> ctypes :: c_int ; } extern "C" { pub fn TTF_GetFontKerning ( font : * const TTF_Font ) -> ctypes :: c_int ; } extern "C" { pub fn TTF_SetFontKerning ( font : * mut TTF_Font , allowed : ctypes :: c_int ) ; } extern "C" { pub fn TTF_FontFaces ( font : * const TTF_Font ) -> ctypes :: c_long ; } extern "C" { pub fn TTF_FontFaceIsFixedWidth ( font : * const TTF_Font ) -> ctypes :: c_int ; } extern "C" { pub fn TTF_FontFaceFamilyName ( font : * const TTF_Font ) -> * mut ctypes :: c_char ; } extern "C" { pub fn TTF_FontFaceStyleName ( font : * const TTF_Font ) -> * mut ctypes :: c_char ; } extern "C" { pub fn TTF_GlyphIsProvided ( font : * const TTF_Font , ch : Uint16 ) -> ctypes :: c_int ; } extern "C" { pub fn TTF_GlyphMetrics ( font : * mut TTF_Font , ch : Uint16 , minx : * mut ctypes :: c_int , maxx : * mut ctypes :: c_int , miny : * mut ctypes :: c_int , maxy : * mut ctypes :: c_int , advance : * mut ctypes :: c_int ) -> ctypes :: c_int ; } extern "C" { pub fn TTF_SizeText ( font : * mut TTF_Font , text : * const ctypes :: c_char , w : * mut ctypes :: c_int , h : * mut ctypes :: c_int ) -> ctypes :: c_int ; } extern "C" { pub fn TTF_SizeUTF8 ( font : * mut TTF_Font , text : * const ctypes :: c_char , w : * mut ctypes :: c_int , h : * mut ctypes :: c_int ) -> ctypes :: c_int ; } extern "C" { pub fn TTF_SizeUNICODE ( font : * mut TTF_Font , text : * const Uint16 , w : * mut ctypes :: c_int , h : * mut ctypes :: c_int ) -> ctypes :: c_int ; } extern "C" { pub fn TTF_RenderText_Solid ( font : * mut TTF_Font , text : * const ctypes :: c_char , fg : SDL_Color ) -> * mut SDL_Surface ; } extern "C" { pub fn TTF_RenderUTF8_Solid ( font : * mut TTF_Font , text : * const ctypes :: c_char , fg : SDL_Color ) -> * mut SDL_Surface ; } extern "C" { pub fn TTF_RenderUNICODE_Solid ( font : * mut TTF_Font , text : * const Uint16 , fg : SDL_Color ) -> * mut SDL_Surface ; } extern "C" { pub fn TTF_RenderGlyph_Solid ( font : * mut TTF_Font , ch : Uint16 , fg : SDL_Color ) -> * mut SDL_Surface ; } extern "C" { pub fn TTF_RenderText_Shaded ( font : * mut TTF_Font , text : * const ctypes :: c_char , fg : SDL_Color , bg : SDL_Color ) -> * mut SDL_Surface ; } extern "C" { pub fn TTF_RenderUTF8_Shaded ( font : * mut TTF_Font , text : * const ctypes :: c_char , fg : SDL_Color , bg : SDL_Color ) -> * mut SDL_Surface ; } extern "C" { pub fn TTF_RenderUNICODE_Shaded ( font : * mut TTF_Font , text : * const Uint16 , fg : SDL_Color , bg : SDL_Color ) -> * mut SDL_Surface ; } extern "C" { pub fn TTF_RenderGlyph_Shaded ( font : * mut TTF_Font , ch : Uint16 , fg : SDL_Color , bg : SDL_Color ) -> * mut SDL_Surface ; } extern "C" { pub fn TTF_RenderText_Blended ( font : * mut TTF_Font , text : * const ctypes :: c_char , fg : SDL_Color ) -> * mut SDL_Surface ; } extern "C" { pub fn TTF_RenderUTF8_Blended ( font : * mut TTF_Font , text : * const ctypes :: c_char , fg : SDL_Color ) -> * mut SDL_Surface ; } extern "C" { pub fn TTF_RenderUNICODE_Blended ( font : * mut TTF_Font , text : * const Uint16 , fg : SDL_Color ) -> * mut SDL_Surface ; } extern "C" { pub fn TTF_RenderText_Blended_Wrapped ( font : * mut TTF_Font , text : * const ctypes :: c_char , fg : SDL_Color , wrapLength : Uint32 ) -> * mut SDL_Surface ; } extern "C" { pub fn TTF_RenderUTF8_Blended_Wrapped ( font : * mut TTF_Font , text : * const ctypes :: c_char , fg : SDL_Color , wrapLength : Uint32 ) -> * mut SDL_Surface ; } extern "C" { pub fn TTF_RenderUNICODE_Blended_Wrapped ( font : * mut TTF_Font , text : * const Uint16 , fg : SDL_Color , wrapLength : Uint32 ) -> * mut SDL_Surface ; } extern "C" { pub fn TTF_RenderGlyph_Blended ( font : * mut TTF_Font , ch : Uint16 , fg : SDL_Color ) -> * mut SDL_Surface ; } extern "C" { pub fn TTF_CloseFont ( font : * mut TTF_Font ) ; } extern "C" { pub fn TTF_Quit ( ) ; } extern "C" { pub fn TTF_WasInit ( ) -> ctypes :: c_int ; } extern "C" { pub fn TTF_GetFontKerningSize ( font : * mut TTF_Font , prev_index : ctypes :: c_int , index : ctypes :: c_int ) -> ctypes :: c_int ; } extern "C" { pub fn TTF_GetFontKerningSizeGlyphs ( font : * mut TTF_Font , previous_ch : Uint16 , ch : Uint16 ) -> ctypes :: c_int ; } pub type __builtin_va_list = [ __va_list_tag ; 1usize ] ; # [ repr ( C ) ] # [ derive ( Debug , Copy , Clone ) ] pub struct __va_list_tag { pub gp_offset : ctypes :: c_uint , pub fp_offset : ctypes :: c_uint , pub overflow_arg_area : * mut ctypes :: c_void , pub reg_save_area : * mut ctypes :: c_void , } # [ test ] fn bindgen_test_layout___va_list_tag ( ) { assert_eq ! ( :: core :: mem :: size_of :: < __va_list_tag > ( ) , 24usize , concat ! ( "Size of: " , stringify ! ( __va_list_tag ) ) ) ; assert_eq ! ( :: core :: mem :: align_of :: < __va_list_tag > ( ) , 8usize , concat ! ( "Alignment of " , stringify ! ( __va_list_tag ) ) ) ; assert_eq ! ( unsafe { & ( * ( :: core :: ptr :: null :: < __va_list_tag > ( ) ) ) . gp_offset as * const _ as usize } , 0usize , concat ! ( "Offset of field: " , stringify ! ( __va_list_tag ) , "::" , stringify ! ( gp_offset ) ) ) ; assert_eq ! ( unsafe { & ( * ( :: core :: ptr :: null :: < __va_list_tag > ( ) ) ) . fp_offset as * const _ as usize } , 4usize , concat ! ( "Offset of field: " , stringify ! ( __va_list_tag ) , "::" , stringify ! ( fp_offset ) ) ) ; assert_eq ! ( unsafe { & ( * ( :: core :: ptr :: null :: < __va_list_tag > ( ) ) ) . overflow_arg_area as * const _ as usize } , 8usize , concat ! ( "Offset of field: " , stringify ! ( __va_list_tag ) , "::" , stringify ! ( overflow_arg_area ) ) ) ; assert_eq ! ( unsafe { & ( * ( :: core :: ptr :: null :: < __va_list_tag > ( ) ) ) . reg_save_area as * const _ as usize } , 16usize , concat ! ( "Offset of field: " , stringify ! ( __va_list_tag ) , "::" , stringify ! ( reg_save_area ) ) ) ; } 
 /// < Private 
